...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "inline-flex h-11 min-h-[44px] items-center justify-center rounded-pill px-3 font-mono text-[11px] uppercase tracking-wider text-ink-3 transition outline-none",
