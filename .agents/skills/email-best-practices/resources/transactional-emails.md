...
Clear, actionable emails that users expect and need—password resets,
confirmations, OTPs.
...
Include identifiers when helpful: order numbers, account names, expiration
times.
...
**Hierarchy:** Header → Primary message → Details → Action button → Secondary
info

**Format:** Short paragraphs (2-3 sentences), bullet points, bold for emphasis,
white space.
