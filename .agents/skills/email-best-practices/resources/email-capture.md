...
Collecting email addresses responsibly with validation, verification, and proper
consent.
...
**Timing:** Send immediately, include expiration (24-48 hours), allow resend
after 60 seconds, limit resend attempts (3/hour).
...
- Don't include OTP/2FA codes in subject line or preview text as it discourages
  opens
...
See [Transactional Emails](./transactional-emails.md) for detailed email design
guidance.
...
- [Deliverability](./deliverability.md) - How validation improves sender
  reputation
