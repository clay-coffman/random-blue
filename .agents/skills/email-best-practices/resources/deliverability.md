...
**Required by Gmail/Yahoo/Microsoft** - unauthenticated emails will be rejected
or spam-filtered.
...
**Expected output:** Each command should return your configured record. No
output = record missing.
...
**Do:** Send to engaged users, keep bounce <4%, complaints <0.1%, remove
inactive subscribers.

**Don't:** Send to purchased lists, ignore bounces/complaints, send inconsistent
volumes
...
**Feedback loops:** Set up with Gmail (Postmaster Tools), Yahoo, Microsoft SNDS.
Remove complainers immediately.

## Infrastructure

**Dedicated sending domain:** Use different subdomains for different sending
purposes (e.g., `t.yourdomain.com` for transactional emails and
`m.yourdomain.com` for marketing emails).
...
2. List-Unsubscribe header — required by Gmail/Yahoo since Feb 2024 (see
...
- [Google Postmaster Tools](https://postmaster.google.com) - Domain reputation
  and spam rates
- [mail-tester.com](https://www.mail-tester.com) - Send a test email, get
  deliverability score
- [MXToolbox](https://mxtoolbox.com/blacklists.aspx) - Check blacklist status

## Related

- [List Management](./list-management.md) - Handle bounces and complaints to
  protect reputation
- [Sending Reliability](./sending-reliability.md) - Retry logic and error
  handling
