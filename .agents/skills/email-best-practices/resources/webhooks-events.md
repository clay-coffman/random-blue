...
Webhooks may be sent multiple times. Use event IDs to prevent duplicate
processing.
...
**Verify handling:** Send test events through Resend dashboard or manually
...
- [List Management](./list-management.md) - What to do with bounce/complaint
  data
