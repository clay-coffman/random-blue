...
React Email officially supports three popular i18n libraries: next-intl,
react-i18next, and react-intl.
				...
				<Body className="bg-gray-100 font-sans">
					<Container className="mx-auto max-w-xl px-5 py-10">
						...
						<Button
							...
							className="block rounded bg-blue-600 px-5 py-3 text-center text-white no-underline"
						>
							{t('cta')}
						</Button>
				...
				<Body className="bg-gray-100 font-sans">
					<Container className="mx-auto max-w-xl px-5 py-10">
						...
						<Button
							...
							className="my-5 block rounded bg-blue-600 px-5 py-3 text-center text-white no-underline"
						>
							{t('view-order')}
						</Button>
						<Hr className="my-5 border-gray-200" />
